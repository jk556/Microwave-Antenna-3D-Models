%  Hi 
% I am Mohammad Hosseinzadeh 
% This is an example of patch antenna
% you can use these codes to simulate it on HFSS.All the codes and 
% functions have guide. Have fun 
...
addpath('E:\دانشگاه\ترم 5\مایکروویو\CA\final project\Challange 1_3\Callange1.2\all codes you need\my example');  

hfssIncludePaths('E:\دانشگاه\ترم 5\مایکروویو\CA\final project\Challange 1_3\Callange1.2\all codes you need\');
